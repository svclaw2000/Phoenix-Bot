...
public class AttributeSet {
	...
	{
		int nCt, nCtMax = attributes.size();
		String oRet =  nCtMax + "\n";
		for( nCt = 0; nCt < nCtMax; ++nCt )
		{
			oRet += ( attributes.get( nCt ).getExpression() );			
		}
		return oRet;
	}
	...
	public void replaceAttribute( Attribute oNewAtt, int nIndex )
	{
		attributes.setElementAt( oNewAtt, nIndex );
	}
